...
let keyConfig=[
  ...
  {name:'branch_code', type:'String', header:'Branch code',edit:1, validate:{required:1}},
  {name:'name', type:'String', header:'Name', edit:1, validate:{required:1}},
		...
		try {
			...
			//	}
				...
				for (var i = 0; i < len; i++) {
					...
					if(this_['__EMPTY'] || this_['対応ｺｰﾄﾞ'] || this_['処置等（１）']){
						obj.push({
							"corr_code": this_['対応ｺｰﾄﾞ'],
							"receipt": recept,
							"branch_code": this_['__EMPTY'],
							"name": this_['処置等（１）'],
							"created_at":clock,
							"updated_at":clock,
							"created_by": 1
