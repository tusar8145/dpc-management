...
let keyConfig=[
  {name:'corr_code', type:'String', header:'Correspondence code', edit:1, validate:{required:1}},
  {name:'dpc', type:'String', header:'DPC First 6 Digits', edit:1, validate:{required:1}},
  {name:'disease_name', type:'String', header:'Disease name', edit:1, validate:{required:1}},
  {name:'drug_name', type:'String', header:'Drug name: Treatment name', edit:1, validate:{required:1}},
		...
		try {
			...
			//	}
				...
				for (var i = 0; i < len; i++) {
					...
					if(this_['MDCｺｰﾄﾞ'] || this_['分類ｺｰﾄﾞ'] || this_['対応ｺｰﾄﾞ'] || this_['ICDｺｰﾄﾞ'] || this_['ICD名称']){
						obj.push({

							
							"receipt": recept,
							"corr_code": this_['対応ｺｰﾄﾞ'],
							"dpc": (this_['MDCｺｰﾄﾞ']+this_['分類ｺｰﾄﾞ']).toString(),
							"disease_name": this_['ICDｺｰﾄﾞ'],
							"drug_name": 'ICD名称',
