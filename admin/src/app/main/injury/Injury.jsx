...
console.log('ffff',data)
	...
	const { t } = useTranslation('InjuryPage');
				...
				<div className="p-24">
					...
					<form onSubmit={doSomething} style={{ marginTop: " 50px" }}>
						...
						<div className=" " style={{ marginLeft: "15%" }}>
									...
									<Button color="primary" type="submit" tabIndex={-1} data-id={1} variant="contained" > <Icon>upload</Icon> Upload   </Button>
